...
<section className="mt-10">
  ...
  <p className="mt-3 text-gray-600">
    ...
    <strong> Vue 3</strong> using <strong>Vite</strong> as the development
    environment.
  </p>

  <p className="mt-3 text-gray-600">
    You can scaffold a Vue project using:
  </p>
    ...
    v3, Pinia for state management, and GSAP for animations.
      ...
      <section className="mt-10">
        ...
        <p className="mt-3 text-gray-600">
          ...
          the <code className="px-1 mx-1 bg-gray-200 rounded">--framework</code>
          flag.
        </p>
...
npx create-bawo-frontend my-app --framework svelte`}
        ...
        <p className="mt-3 text-gray-600">
          The generated Svelte project includes:
        </p>
        ...
        <p className="mt-3 text-gray-600">
          Example setup with TypeScript and Tailwind:
        </p>
...
npx create-bawo-frontend my-app --framer --gsap`}
      ...
      <section className="mt-10">
        ...
        />
      <p className="mt-7 text-gray-600 font-semibold">Note: Vue doesnot support framer and tailwind v4 yet.</p>  
      </section>
    </div>
    </div>
  );
